...
SECRET_KEY = 'django-insecure-y%#3_d1g@e^x+63&p@k0)pfd&b3m0@4f_azv6g_!j+=p1ccoow'
...
INSTALLED_APPS = [
    'forum',
    'crispy_forms',  # Optionnel pour des formulaires stylisés
...
# Choix du style pour crispy_forms 
